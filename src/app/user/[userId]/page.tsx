  ...
  {user ? (<section className="bg-white dark:bg-white">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-gray-900">Tableau de bord</h2>
            {/* <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400"></p> */}
        </div> 
        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            {/* Information perso */}
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-50 dark:border-gray-700">
                    <div className='p-2'>    
