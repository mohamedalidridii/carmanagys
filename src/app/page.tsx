...
export default function Home() {
  ...
  <MaxWidthWrapper>
    <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
      <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-6x1'>
        Your Number 1 choice{' '}
        <span className='text-blue-600'>Digital Assets
        </span>
      </h1>
      <p className='mt-6 text-lg max-w-prose text-muted-foreground'>
        Welcome to Digitalecom. Every asset on our platform 
        is verified by our team to ensure our highest quality standars.
      </p>
